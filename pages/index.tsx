...
// Dynamically import the starry background (no SSR)
...
export default function Home({
  ...
  useEffect(() => {
    if (
      ...
      if (query) {
        ...
        const incoming = ssrArticles.filter(
          (a) => !existingIds.has(a.article_id || a.link)
        );
  ...
  return (
    <>
      ...
      <div className="relative z-10 min-h-screen bg-transparent text-gray-800 dark:text-gray-100 transition-colors duration-300">
        {/* Pass current theme to StarryBackground */}
